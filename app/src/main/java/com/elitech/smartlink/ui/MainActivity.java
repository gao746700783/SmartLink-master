...
public class MainActivity extends BaseActivity
    ...
    private BaseQuickAdapter<String, BaseAdapterHelper> mAdapter;
...
//                        .setAction("Action", null).show();
    ...
    private void setupListView() {
        lv_mydevices = (ListView) findViewById(R.id.lv_mydevices);
        mAdapter = new QuickAdapter<String>(this, android.R.layout.simple_list_item_1) {

            @Override
            protected void convert(BaseAdapterHelper helper, String item) {
                helper.setText(android.R.id.text1, item == null || item.equals("") ? "未知设备" : item);
            }

        };

        lv_mydevices.setAdapter(mAdapter);

        lv_mydevices.setOnItemClickListener(new AdapterView.OnItemClickListener() {
    ...
    protected void onResume() {
        ...
        mDeviceList.clear();
        mDeviceList.add("未知设备1");
        mDeviceList.add("未知设备2");
        mDeviceList.add("未知设备3");
        mAdapter.clear();
