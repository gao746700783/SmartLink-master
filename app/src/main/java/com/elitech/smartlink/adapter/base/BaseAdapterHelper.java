 ...
 */
package com.elitech.smartlink.adapter.base;
...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setTextColorRes(int viewId, int textColorRes) {
        TextView view = retrieveView(viewId);
//        view.setTextColor(context.getResources().getColor(textColorRes, null));
        view.setTextColor(ResourceUtil.getColor(context, textColorRes));
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageUrl(int viewId, int imageUrl) {
        ImageView view = retrieveView(viewId);
        Picasso.with(context).load(imageUrl).resize(200, 200)
